...
s_window = PROD([window,Q(0.3)])
s2_window = PROD([S([1,2])([1.1,1.1])(window),Q(0.3)])
ark_n = COLOR([0.80,0.73,0.52])((T([1,2,3])([18,3,0.5])(DIFFERENCE([s2_window,s_window]))))
ark_w = R([1,2])(PI/2)(ark_n)
ark_s = T([1,2])([36,36])(R([1,2])(PI/2)(ark_w))
ark_e = T([1,2])([72,0])(R([1,2])(PI/2)(ark_s))



north_w = R([2,3])(PI/2)(STRUCT([PROD([(DIFFERENCE([plane,T([1,2])([18,3])(window)])),Q(1)])]))
...
north_d = R([2,3])(PI/2)(PROD([(DIFFERENCE([plane,T([1,2])([18,1.8])(window)])),Q(1)]))


basew = COLOR([0.80,0.60,0.50])(T([1,2])([2,2])(STRUCT([north_w,west_w,south_w,east_w])))
base0 = COLOR([0.80,0.60,0.50])(T([1,2])([2,2])(STRUCT([north_d,west,south,east])))
...
roof0 = COLOR([0.57,0.77,0.45])(DIFFERENCE([((JOIN([roof_middle,roof_down,roof_up]))),dif_roof]))
...
basement = COLOR([0.8,0.8,0.8])(PROD([basement_plane,Q(3)]))
