...
bezier0 = COLOR([1,0.64,0])(T([1,2,3])([13.3,2.9,-1.6])(R([1,3])(PI)(bezier_final)))
...
hor_fix_block = COLOR([1,0.64,0])(STRUCT(MKPOLS(assemblyDiagramInit([1,1,1])([[1.6],[17.8],[.4]]))))
...
bezier_final = COLOR([1,0.64,0])(T(1)(0)(STRUCT([bezier0,bezier1,bezier2])))
...
top_bezier = COLOR([1,0.64,0])(STRUCT([bezier0,bezier1,bezier2]))
structure = STRUCT([structure,T(2)(16.5)(top_bezier)])

rooftop = assemblyDiagramInit([1,1,1])([[10],[.5],[23.2]])
rooftop = COLOR([0.4,.4,.4])(STRUCT(MKPOLS(rooftop)))

structure = STRUCT([structure,T([1,2,3])([.4,17.4,-11.6])(rooftop)])

floors = COLOR([0.4,.4,.4])(STRUCT(MKPOLS(assemblyDiagramInit([1,1,1])([[10.8],[.3],[7.3]]))))
floors = STRUCT(NN(4)([T(2)(3.6),floors]))

structure = (STRUCT([structure,T([1,2,3])([0,-.3,4.5])(floors),T([1,2,3])([0,-.3,-11.8])(floors)]))

floors = COLOR([0.4,.4,.4])(STRUCT(MKPOLS(assemblyDiagramInit([1,1,1])([[5],[.3],[9]]))))
floors = STRUCT(NN(4)([T(2)(3.6),floors]))
...
atrium = COLOR([1,0.64,0])(DIFFERENCE([atrium,T(3)(4)(door)]))
