...
Examples =
{
	...
	{
		positionStyle    : Type.CUBE,
		positionBase     : new THREE.Vector3( 0, 100, -50 ),
		positionSpread   : new THREE.Vector3( 10, 0, 10 ),
		...
		particleTexture : THREE.ImageUtils.loadTexture( 'assets/textures/general/smoke.png'),
	...
	{
		positionStyle  : Type.CUBE,
		positionBase   : new THREE.Vector3( -75, 70,  0 ),
		...
		emitterDeathAge    : 10000000000000000
	},
